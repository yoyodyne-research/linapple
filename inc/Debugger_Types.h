...
/* i.e.
   ...
   token: EQUAL; (3) type: address, token:DOLLAR
    BP LOAD            type:
...
enum Parameters_e {
  ...
  //    , PARAM_CODE_1  // disasm top // removed, since can't set top window for
  //    code/data
  ,
  ...
  PARAM_CONSOLE,
  PARAM_DATA // data all
  //    , PARAM_DATA_1  // data top // removed, since can't set top window for
  //    code/data
  ,
  ...
  //    , PARAM_SOURCE_1 // source top // removed, since can't set top window
  //    for code/data
  ,
  ...
  //    , PARAM_SYMBOL_1 // symbols top // removed, since can't set top window
  //    for code/data
  ,
