...
// *** DON'T CHANGE ANY STRUCT WITHOUT CONSIDERING BACKWARDS COMPATIBILITY WITH
// .AWS FORMAT ***

#define MAKE_VERSION(a, b, c, d) ((a << 24) | (b << 16) | (c << 8) | (d))

#define AW_SS_TAG                                                              \
  (('S' << 24) | ('S' << 16) | ('W' << 8) | 'A') // 'AWSS' = AppleWin SnapShot
...
typedef struct { unsigned __int64 g_nJoyCntrResetCycle; } SS_IO_Joystick;
...
typedef struct { unsigned __int64 g_nSpkrLastCycle; } SS_IO_Speaker;
...
typedef struct { SS_CARD_HDR Hdr; } SS_CARD_EMPTY;
