...
Custom
   ...
   Orange      9         9  5   3      $0F60    (F,6,0) -> (FF,80,00) Custom
(modified to match better with the other Hi-Res Colors)
...
bool VideoGetSW80COL() { return SW_80COL != 0; }
...
WORD VideoGetScannerAddress(bool *pbVblBar_OUT, const DWORD uExecutedCycles) {
  ...
  if (SW_HIRES && SW_MIXED && (v_4 & v_2)) // NICK: Should this be (SW_HIRES &&
                                           ...
                                           // 'SW_HIRES' ?
  // GPH: No, because there's a distinctive hires/text mixed mode, with text on
  // the bottom four text rows.
