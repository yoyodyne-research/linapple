...
enum AppMode_e {
	MODE_LOGO = 0,
	MODE_PAUSED,
	MODE_RUNNING // 6502 is running at normal speed (Debugger breakpoints
		     // may or may not be active)
	,
	MODE_DEBUG // 6502 is paused
	,
	MODE_STEPPING // 6502 is running at full speed (Debugger breakpoints
		      // always active)
};
...
typedef BYTE (*iofunction)(WORD nPC, WORD nAddr, BYTE nWriteFlag,
			   BYTE nWriteValue, ULONG nCyclesLeft);
...
// NB. These get persisted to the Registry,
// so don't change the values for these enums!
enum eApple2Type {
	A2TYPE_APPLE2 = 0,
	A2TYPE_APPLE2PLUS,
