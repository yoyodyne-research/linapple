...
int SDL_SoftStretchMono8(
    SDL_Surface *src, SDL_Rect *srcrect, SDL_Surface *dst, SDL_Rect *dstrect,
    Uint8 brush) { // brush - monochrome color (index from palette)
  int src_locked;
  int dst_locked;
  int pos, inc;
  int dst_width;
...
///////////////////////////////////////////////////////////////////////////////////////////////
/*	SDL_SoftStretchOr	- the same as SDL_SoftStretch, but ORed with
   destination
...
void font_print(int x, int y, const char *text, SDL_Surface *surface, double kx,
                double ky) { // kx, ky - stretching koefficients for width and
                             // height of destination chars respectively
  int i, c;
  SDL_Rect s, d;
...
void font_print_right(int x, int y, const char *text, SDL_Surface *surface,
                      double kx,
                      double ky) { // kx, ky - stretching koefficients for width
                                   // and height of destination chars
                                   // respectively
  int i, c;
  SDL_Rect s, d;
...
void font_print_centered(int x, int y, const char *text, SDL_Surface *surface,
                         double kx,
                         double ky) { // kx, ky - stretching koefficients for
                                      // width and height of destination chars
                                      // respectively
  int i, c;
  SDL_Rect s, d;
...
void surface_fader(SDL_Surface *surface, float r_factor, float g_factor,
  ...
  colors = (SDL_Color *)
               surface->format->palette->colors; // get pointer to origin colors
  for (i = 0; i < 256; i++) {
