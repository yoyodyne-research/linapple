...
public:
  ...
  static BYTE SSC_IORead(WORD PC, WORD uAddr, BYTE bWrite, BYTE uValue,
                         ULONG nCyclesLeft);
  static BYTE SSC_IOWrite(WORD PC, WORD uAddr, BYTE bWrite, BYTE uValue,
                          ULONG nCyclesLeft);
...
private:
  ...
  // how does CRITICAL_SECTION work in Linux? -- see in Wikipedia:
  // http://en.wikipedia.org/wiki/Critical_section
  // --> to main file
  //	CRITICAL_SECTION	m_CriticalSection;	// To guard
  ///g_vRecvBytes/
