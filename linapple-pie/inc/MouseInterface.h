...
#define WRITE_HANDLER(func)                                                    \
  void func(void *objFrom, void *objTo, int nAddr, BYTE byData)
#define CALLBACK_HANDLER(func)                                                 \
  void func(void *objFrom, void *objTo, LPARAM lParam)
...
public:
  ...
  void SetSlotRom();
  static BYTE IORead(WORD PC, WORD uAddr, BYTE bWrite, BYTE uValue,
                     ULONG nCyclesLeft);
  static BYTE IOWrite(WORD PC, WORD uAddr, BYTE bWrite, BYTE uValue,
                      ULONG nCyclesLeft);
